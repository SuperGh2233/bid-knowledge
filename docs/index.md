...
| 文档 | 状态 | 何时读 |
|---|---|---|
| `plans/active/PLAN-20260917-round2-feedback.md` | **active（已立项，未开工）** | **第二次需求对接**：可复制正文段落（痛点主项）/ 仪器空壳行治理 / 纳税社保总金额（新 fact_type `finance_amount`）/ 生成 outline 严格标题约束；四项口径用户已拍板（§3），实测诊断 D1–D5 见 §2 |
